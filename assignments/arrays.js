...
//let lastCar = inventory.length(lastMake, lastModel){
 //   console.log(in)
//}
console.log(`Make: ${inventory[49].car_make} Model:${inventory[49].car_model}`);
...
//Once you have populated the BMWAndAudi array, use JSON.stringify(){takes all data and wraps it in a string} to show the results of the array in the console.
let BMWAndAudi = [];
